...
Apio IDE currently supports over 100 FPGA boards, custom boards can be easily added, and it includes about 100 ready-to-use example projects. Apio CLI currently supports the ICE40, ECP5, Gowin, and Xilinx 7 Series FPGA architectures.
